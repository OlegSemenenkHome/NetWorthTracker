package com.networthtracker.data.service

import com.networthtracker.data.AssetService
import com.networthtracker.data.BuildConfig
import com.networthtracker.data.CandleData
...
class AssetServiceImpl @Inject constructor(
    ...
    override suspend fun stockPriceUpdate(asset: Asset): Result<Asset> {
        return runCatching {
